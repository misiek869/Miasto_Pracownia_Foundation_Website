	...
	return (
		<Link href={link}>
			<button
				...
				<div className='absolute right-1 inline-flex h-12 w-12 items-center justify-end rounded-full bg-slate-50 transition-[width] group-hover:w-[calc(100%-8px)]'>
					<div className='mr-3.5 flex items-center justify-center pointer-events-none'>
						<svg
							width='15'
							height='15'
							viewBox='0 0 15 15'
